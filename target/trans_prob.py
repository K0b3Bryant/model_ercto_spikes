...
def main():
    ...
    # Markov Switching Regression model with Hierarchical Priors
    n = len(data)
    with pm.Model() as model:
        # Prior:normal distribution centered at 0 with standard deviation 2.
        ...
        # Initial state probabilities: uniform Dirichlet distribution.
